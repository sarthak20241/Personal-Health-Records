 ...
 * Use the {@link delete_abha_id_via_mobile_fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class delete_abha_id_via_mobile_fragment extends Fragment {
    ...
    public delete_abha_id_via_mobile_fragment() {
        // Required empty public constructor
    }


    public static delete_abha_id_via_mobile_fragment newInstance(String param1, String param2) {
        delete_abha_id_via_mobile_fragment fragment = new delete_abha_id_via_mobile_fragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_delete_abha_id_via_mobile_fragment, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        delete_abha_btn = getView().findViewById(R.id.abha_delete_abha_via_mobile_delete_btn);
//        aadhaar_no_et = getView().findViewById(R.id.abha_forgot_abha_via_aadhaar_aadhaar_no_et);
        otp_et = getView().findViewById(R.id.abha_delete_abha_via_mobile_otp_et);
        get_otp = getView().findViewById(R.id.abha_delete_abha_via_mobile_get_otp_btn);
...
//                    json_request.put("otp", otp_et.getText().toString());
                ...
                Call<Response_Model> call = apiService.abha_delete_via_mobile_get_otp_createPost(requestModel);
...
//                                Toast.makeText(Abha_Login.this, jObjError.getString("message"), Toast.LENGTH_LONG).show();
        ...
        delete_abha_btn.setOnClickListener(new View.OnClickListener() {
            ...
            private void verify_otp() {
                ...
                Request_Model requestModel = new Request_Model(req);
                Call<Response_Model> call = apiService.abha_delete_via_mobile_verify_otp_and_delete_createPost(requestModel);
                call.enqueue(new Callback<Response_Model>() {
                    @Override
                    public void onResponse(Call<Response_Model> call, Response<Response_Model> response) {
                        if (response.isSuccessful()) {
                            ...
                            try {
                                ...
                                if(obj != null){
                                    ...
                                    if(obj.getString("status").equals("deleted")){
                                        ...
                                        AlertDialog alertDialog14 = new AlertDialog.Builder(getActivity()).create();
                                        alertDialog14.setTitle("Error");
                                        alertDialog14.setIcon(R.drawable.baseline_error_24);
                                        alertDialog14.setMessage("Some Error occurred! Abha NOT deleted!");
                                        alertDialog14.setButton(DialogInterface.BUTTON_POSITIVE,"OK", new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialogInterface, int i) {
...
//                                    Toast.makeText(getActivity(), "ABHA Deleted Successfully !\n Taking back to HomePage...", Toast.LENGTH_SHORT).show();
