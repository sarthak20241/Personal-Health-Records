 ...
 * Use the {@link retrieve_abha_id_via_aadhaar#newInstance} factory method to
 * create an instance of this fragment.
 */
public class retrieve_abha_id_via_aadhaar extends Fragment {

    private Button retrieve_abha_btn;
    ...
    public retrieve_abha_id_via_aadhaar() {
        // Required empty public constructor
    }


    public static retrieve_abha_id_via_aadhaar newInstance(String param1, String param2) {
        retrieve_abha_id_via_aadhaar fragment = new retrieve_abha_id_via_aadhaar();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_retrieve_abha_id_via_aadhaar, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        retrieve_abha_btn = getView().findViewById(R.id.abha_forgot_abha_via_aadhaar_retrieve_btn);
        ...
        get_otp = getView().findViewById(R.id.abha_forgot_abha_via_aadhaar_get_otp_btn);
...
//                    json_request.put("otp", otp_et.getText().toString());
                ...
                Call<Response_Model> call = apiService.abha_forgot_abha_retrieve_via_aadhaar_get_otp_createPost(requestModel);
...
//                                    Log.d("api" , String.valueOf(isMobileLinkedWithAadhaar));
                                    ...
                                    retrieve_abha_btn.setEnabled(true);
                                    retrieve_abha_btn.getBackground().setTintList(
...
//                                Toast.makeText(Abha_Login.this, jObjError.getString("message"), Toast.LENGTH_LONG).show();
        ...
        retrieve_abha_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                verify_otp();
            }
            ...
            private void verify_otp() {
                ...
                Request_Model requestModel = new Request_Model(req);
                Call<Response_Model> call = apiService.abha_forgot_abha_retrieve_via_aadhaar_verify_otp_createPost(requestModel);
                call.enqueue(new Callback<Response_Model>() {
                    @Override
                    public void onResponse(Call<Response_Model> call, Response<Response_Model> response) {
                        if (response.isSuccessful()) {
                            ...
                            try {
                                ...
                                if(obj != null){
                                    ...
                                    {
                                        Toast.makeText(getActivity(), "An Unknown Error has been occurred", Toast.LENGTH_SHORT).show();
                                        e.printStackTrace();
                                    }


                                    Bundle bundle1 = new Bundle();
                                    bundle1.putString("health_id" , health_id);
                                    retrieve_abha_id_successfully_fragment frag = new retrieve_abha_id_successfully_fragment();
